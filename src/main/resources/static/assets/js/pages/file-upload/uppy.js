...
var KTUppy = function () {
    ...
    var initUppy5 = function () {
        ...
        $(id + ' .uppy-FileInput-container').append('<label class="uppy-input-label btn btn-light-primary btn-sm btn-bold" for="' + (elemId + '_input_control') + '">Adjuntar archivo</label>');
        ...
        $(document).on('click', id + ' .uppy-list .uppy-list-remove', function () {
            ...
            $fileLabel.show();
            $fileLabel.text("Adjuntar Archivo");
